...
public class Stream_02_Test {
	...
	public void test_mapToDouble_sum() throws Exception {
		 ...
		 * commandes)
		 */
		double result = orders.stream().map(o -> o.getPrice()).reduce(0.0, Double::sum);
	...
	public void test_mapToDouble_avg() throws Exception {
		 ...
		 */
		OptionalDouble result = OptionalDouble.of(orders.stream().collect(Collectors.averagingDouble(o -> o.getPrice())));
